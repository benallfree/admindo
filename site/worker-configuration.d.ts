/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 58d619015615bdd13908640df8f91c92)
// Runtime types generated with workerd@1.20250525.0 2025-05-04 
declare namespace Cloudflare {
	interface Env {
		ADMINDO_SUPERUSER_USERNAME: string;
		ADMINDO_SUPERUSER_PASSWORD: string;
		MY_DURABLE_OBJECT: DurableObjectNamespace<import("./src/index").MyDurableObject>;
		MY_DURABLE_OBJECT_2: DurableObjectNamespace<import("./src/index").MyDurableObject2>;
	}
}
